export default function BlogDetails(){
  ...
  <section
    ...
    data-setbg="/assets/img/blog/details/details-hero.jpg"
    style={{background:'url("/assets/img/blog/details/details-hero.jpg")'}}
  >
          ...
          <div className="blog-details-text">
            ...
            <div className="blog-details-pic">
              <div className="blog-details-pic-item">
                <img src="/assets/img/blog/details/details-1.jpg" alt="" />
              </div>
              <div className="blog-details-pic-item">
                <img src="/assets/img/blog/details/details-2.jpg" alt="" />
              </div>
            </div>
            ...
            <div className="blog-details-quote">
              <div className="quote-icon">
                <img src="/assets/img/blog/details/quote-left.png" alt="" />
              </div>
              <h5>
            ...
            <div className="blog-details-author">
              <div className="ba-pic">
                <img src="/assets/img/blog/details/blog-profile.jpg" alt="" />
              </div>
